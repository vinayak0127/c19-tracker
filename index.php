	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100 img-fluid"alt="Responsive image"src="https://images.unsplash.com/photo-1585912812840-b457972f28d0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" height="700" width="800" alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100 img-fluid"alt="Responsive image" src="https://images.unsplash.com/photo-1583946099379-f9c9cb8bc030?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80" height="800"   alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100 img-fluid"alt="Responsive image" src="https://images.unsplash.com/photo-1583423230902-b653abc541eb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1489&q=80"height="800" alt="Third slide">
			</div>
		</div>
...
<!-- <section class="carouselmob">
	<div class="carousel">
    <a class="carousel-item" href="#one!"><img src="https://images.unsplash.com/photo-1588775046415-869163bf70d9?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=60"></a>
    <a class="carousel-item" href="#two!"><img src="https://images.unsplash.com/photo-1588775017410-b0d77bd85a16?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80"></a>
    <a class="carousel-item" href="#three!"><img src="https://images.unsplash.com/photo-1588773922373-d8225f401dd1?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1554&q=80"></a>
    <a class="carousel-item" href="#four!"><img src="https://images.unsplash.com/photo-1588775073690-3cbd3be13ef0?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=60"></a>
    <a class="carousel-item" href="#five!"><img src="https://images.unsplash.com/photo-1588771997195-ae313583be04?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=60"></a>
  </div>
	...
	<div class="row w-100 h-100" >
		 ...
		 <div class="col-lg-7 col-md-7 col-12 order-lg-2 order-1">
		 	<div class="rightside w-100 h-100 d-flex justify-content-center align-items-center">
		 		<h1  >Let's Stay Safe & Fight Together Against <br>Cor<span class="corona_rot img-hover-zoom"> <img src="images/corona.png"> 
		 		</span>na<br> Virus</h1>
		 	</div>
		 </div>
	</div>
...
<div class="container-fluid sub_section pt-5 pb-5 padding" id="about">
	...
	<div class="row pt-5">
		<div class="col-lg-5 col-md-6 col-12 ml-5 about_res img-hover-zoom">
			<img src="images/aboutcorona.jpg" class="img-fluid"alt="Responsive image">
		</div>
...
<div class="container-fluid  pt-5 pb-5 padding_ " id="symptoms">
	<div class="section_header text-center mb-5 mt-4">
		<h1 class="p-3"> Coronavirus symptoms</h1>
	</div>

	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-4 col-12 mt-5">
				<figure class="text-center img-hover-zoom">
...
<div class="container-fluid sub_section  pt-5 pb-5 padding_" id="prevention">
	<div class="section_header text-center mb-5 mt-4">
		<h1 class="p-3"> 6 Steps Prevention Against Coronavirus </h1>
	</div>
...
<div class="container-fluid   pt-5 pb-5 padding_" id="contact">
	<div class="section_header text-center mb-5 mt-4">
		<h1>Conatact developer</h1>
	</div>
